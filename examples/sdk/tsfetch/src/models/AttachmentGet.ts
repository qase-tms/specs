...
export function AttachmentGetFromJSON(json: any): AttachmentGet {
    return AttachmentGetFromJSONTyped(json, false);
}

export function AttachmentGetFromJSONTyped(json: any, ignoreDiscriminator: boolean): AttachmentGet {
    ...
    return {
        ...
        'fullPath': !exists(json, 'full_path') ? undefined : json['full_path'],
    };
}

export function AttachmentGetToJSON(value?: AttachmentGet | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
