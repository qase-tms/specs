...
export function AttachmentHashFromJSON(json: any): AttachmentHash {
    return AttachmentHashFromJSONTyped(json, false);
}

export function AttachmentHashFromJSONTyped(json: any, ignoreDiscriminator: boolean): AttachmentHash {
...
export function AttachmentHashToJSON(value?: AttachmentHash | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
