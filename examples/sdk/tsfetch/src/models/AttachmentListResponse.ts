...
import {
    ...
    AttachmentListResponseAllOfFromJSON,
    AttachmentListResponseAllOfFromJSONTyped,
    AttachmentListResponseAllOfToJSON,
} from './AttachmentListResponseAllOf';
import {
    AttachmentListResponseAllOfResult,
    AttachmentListResponseAllOfResultFromJSON,
    AttachmentListResponseAllOfResultFromJSONTyped,
    AttachmentListResponseAllOfResultToJSON,
} from './AttachmentListResponseAllOfResult';
import {
    Response,
    ResponseFromJSON,
...
export function AttachmentListResponseFromJSON(json: any): AttachmentListResponse {
    return AttachmentListResponseFromJSONTyped(json, false);
}

export function AttachmentListResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): AttachmentListResponse {
    ...
    return {
        ...
        'result': !exists(json, 'result') ? undefined : AttachmentListResponseAllOfResultFromJSON(json['result']),
    };
}

export function AttachmentListResponseToJSON(value?: AttachmentListResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'status': value.status,
        'result': AttachmentListResponseAllOfResultToJSON(value.result),
    };
}
