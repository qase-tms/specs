...
export function AttachmentListResponseAllOfFromJSON(json: any): AttachmentListResponseAllOf {
    return AttachmentListResponseAllOfFromJSONTyped(json, false);
}

export function AttachmentListResponseAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): AttachmentListResponseAllOf {
...
export function AttachmentListResponseAllOfToJSON(value?: AttachmentListResponseAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
