...
import {
    AttachmentGet,
    AttachmentGetFromJSON,
    AttachmentGetFromJSONTyped,
    AttachmentGetToJSON,
} from './AttachmentGet';
...
export function AttachmentListResponseAllOfResultFromJSON(json: any): AttachmentListResponseAllOfResult {
    return AttachmentListResponseAllOfResultFromJSONTyped(json, false);
}

export function AttachmentListResponseAllOfResultFromJSONTyped(json: any, ignoreDiscriminator: boolean): AttachmentListResponseAllOfResult {
    ...
    return {
        ...
        'entities': !exists(json, 'entities') ? undefined : ((json['entities'] as Array<any>).map(AttachmentGetFromJSON)),
    };
}

export function AttachmentListResponseAllOfResultToJSON(value?: AttachmentListResponseAllOfResult | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'count': value.count,
        'entities': value.entities === undefined ? undefined : ((value.entities as Array<any>).map(AttachmentGetToJSON)),
    };
}
