...
import {
    ...
    AttachmentResponseAllOfFromJSON,
    AttachmentResponseAllOfFromJSONTyped,
    AttachmentResponseAllOfToJSON,
} from './AttachmentResponseAllOf';
import {
    Response,
    ResponseFromJSON,
...
export function AttachmentResponseToJSON(value?: AttachmentResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
