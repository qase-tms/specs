...
export function AttachmentResponseAllOfFromJSON(json: any): AttachmentResponseAllOf {
    return AttachmentResponseAllOfFromJSONTyped(json, false);
}

export function AttachmentResponseAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): AttachmentResponseAllOf {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'result': !exists(json, 'result') ? undefined : AttachmentGetFromJSON(json['result']),
    };
}

export function AttachmentResponseAllOfToJSON(value?: AttachmentResponseAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'result': AttachmentGetToJSON(value.result),
    };
}
