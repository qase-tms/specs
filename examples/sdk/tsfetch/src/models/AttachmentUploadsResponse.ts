...
export function AttachmentUploadsResponseFromJSON(json: any): AttachmentUploadsResponse {
    return AttachmentUploadsResponseFromJSONTyped(json, false);
}

export function AttachmentUploadsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): AttachmentUploadsResponse {
    ...
    return {
        ...
        'result': !exists(json, 'result') ? undefined : ((json['result'] as Array<any>).map(AttachmentGetFromJSON)),
    };
}

export function AttachmentUploadsResponseToJSON(value?: AttachmentUploadsResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'status': value.status,
        'result': value.result === undefined ? undefined : ((value.result as Array<any>).map(AttachmentGetToJSON)),
    };
}
