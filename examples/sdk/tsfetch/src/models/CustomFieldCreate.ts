...
export function CustomFieldCreateFromJSON(json: any): CustomFieldCreate {
    return CustomFieldCreateFromJSONTyped(json, false);
}

export function CustomFieldCreateFromJSONTyped(json: any, ignoreDiscriminator: boolean): CustomFieldCreate {
...
export function CustomFieldCreateToJSON(value?: CustomFieldCreate | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
