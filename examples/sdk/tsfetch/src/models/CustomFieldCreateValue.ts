 ...
 * 
 * @export
 * @interface CustomFieldCreateValue
 */
export interface CustomFieldCreateValue {
    /**
     * 
     * @type {number}
     * @memberof CustomFieldCreateValue
     */
    id?: number;
    /**
     * 
...
export function CustomFieldCreateValueFromJSON(json: any): CustomFieldCreateValue {
    return CustomFieldCreateValueFromJSONTyped(json, false);
}

export function CustomFieldCreateValueFromJSONTyped(json: any, ignoreDiscriminator: boolean): CustomFieldCreateValue {
...
export function CustomFieldCreateValueToJSON(value?: CustomFieldCreateValue | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
