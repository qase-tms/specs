...
export function CustomFieldResponseAllOfFromJSON(json: any): CustomFieldResponseAllOf {
    return CustomFieldResponseAllOfFromJSONTyped(json, false);
}

export function CustomFieldResponseAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): CustomFieldResponseAllOf {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'result': !exists(json, 'result') ? undefined : CustomFieldFromJSON(json['result']),
    };
}

export function CustomFieldResponseAllOfToJSON(value?: CustomFieldResponseAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'result': CustomFieldToJSON(value.result),
    };
}
