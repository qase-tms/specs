...
import {
    ...
    CustomFieldCreateValueFromJSON,
    CustomFieldCreateValueFromJSONTyped,
    CustomFieldCreateValueToJSON,
} from './CustomFieldCreateValue';
...
export interface CustomFieldUpdate {
     ...
     * @memberof CustomFieldUpdate
     */
    replaceValues?: { [key: string]: string; } | null;
    /**
     * 
     * @type {string}
     * @memberof CustomFieldUpdate
...
export function CustomFieldUpdateFromJSON(json: any): CustomFieldUpdate {
    return CustomFieldUpdateFromJSONTyped(json, false);
}

export function CustomFieldUpdateFromJSONTyped(json: any, ignoreDiscriminator: boolean): CustomFieldUpdate {
    ...
    return {
        ...
        'title': json['title'],
        'projectsCodes': json['projects_codes'],
        'value': !exists(json, 'value') ? undefined : (json['value'] === null ? null : (json['value'] as Array<any>).map(CustomFieldCreateValueFromJSON)),
        'replaceValues': !exists(json, 'replace_values') ? undefined : json['replace_values'],
...
export function CustomFieldUpdateToJSON(value?: CustomFieldUpdate | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'value': value.value === undefined ? undefined : (value.value === null ? null : (value.value as Array<any>).map(CustomFieldCreateValueToJSON)),
        'replace_values': value.replaceValues,
