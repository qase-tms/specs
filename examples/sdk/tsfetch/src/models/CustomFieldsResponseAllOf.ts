...
import {
    ...
    CustomFieldsResponseAllOfResultFromJSON,
    CustomFieldsResponseAllOfResultFromJSONTyped,
    CustomFieldsResponseAllOfResultToJSON,
} from './CustomFieldsResponseAllOfResult';

/**
 * 
 * @export
 * @interface CustomFieldsResponseAllOf
 */
export interface CustomFieldsResponseAllOf {
    /**
     * 
     * @type {CustomFieldsResponseAllOfResult}
     * @memberof CustomFieldsResponseAllOf
     */
    result?: CustomFieldsResponseAllOfResult;
}

export function CustomFieldsResponseAllOfFromJSON(json: any): CustomFieldsResponseAllOf {
    return CustomFieldsResponseAllOfFromJSONTyped(json, false);
}

export function CustomFieldsResponseAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): CustomFieldsResponseAllOf {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'result': !exists(json, 'result') ? undefined : CustomFieldsResponseAllOfResultFromJSON(json['result']),
    };
}

export function CustomFieldsResponseAllOfToJSON(value?: CustomFieldsResponseAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'result': CustomFieldsResponseAllOfResultToJSON(value.result),
    };
}
