...
export function CustomFieldsResponseAllOfResultFromJSON(json: any): CustomFieldsResponseAllOfResult {
    return CustomFieldsResponseAllOfResultFromJSONTyped(json, false);
}

export function CustomFieldsResponseAllOfResultFromJSONTyped(json: any, ignoreDiscriminator: boolean): CustomFieldsResponseAllOfResult {
    ...
    return {
        ...
        'entities': !exists(json, 'entities') ? undefined : ((json['entities'] as Array<any>).map(CustomFieldFromJSON)),
    };
}

export function CustomFieldsResponseAllOfResultToJSON(value?: CustomFieldsResponseAllOfResult | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'count': value.count,
        'entities': value.entities === undefined ? undefined : ((value.entities as Array<any>).map(CustomFieldToJSON)),
    };
}
