...
export function DefectCreateFromJSON(json: any): DefectCreate {
    return DefectCreateFromJSONTyped(json, false);
}

export function DefectCreateFromJSONTyped(json: any, ignoreDiscriminator: boolean): DefectCreate {
...
export function DefectCreateToJSON(value?: DefectCreate | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
