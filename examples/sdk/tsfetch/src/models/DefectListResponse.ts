...
import {
    ...
    DefectListResponseAllOfFromJSON,
    DefectListResponseAllOfFromJSONTyped,
    DefectListResponseAllOfToJSON,
} from './DefectListResponseAllOf';
import {
    DefectListResponseAllOfResult,
    DefectListResponseAllOfResultFromJSON,
    DefectListResponseAllOfResultFromJSONTyped,
    DefectListResponseAllOfResultToJSON,
} from './DefectListResponseAllOfResult';
import {
    Response,
    ResponseFromJSON,
...
export interface DefectListResponse {
     ...
     * 
     * @type {boolean}
     * @memberof DefectListResponse
     */
    status?: boolean;
    /**
     * 
     * @type {DefectListResponseAllOfResult}
     * @memberof DefectListResponse
     */
    result?: DefectListResponseAllOfResult;
}

export function DefectListResponseFromJSON(json: any): DefectListResponse {
    return DefectListResponseFromJSONTyped(json, false);
}

export function DefectListResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): DefectListResponse {
    ...
    return {
        ...
        'result': !exists(json, 'result') ? undefined : DefectListResponseAllOfResultFromJSON(json['result']),
    };
}

export function DefectListResponseToJSON(value?: DefectListResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'status': value.status,
        'result': DefectListResponseAllOfResultToJSON(value.result),
    };
}
