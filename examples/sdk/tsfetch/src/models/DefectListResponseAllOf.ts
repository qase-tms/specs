 ...
 * 
 * @export
 * @interface DefectListResponseAllOf
 */
export interface DefectListResponseAllOf {
    /**
     * 
     * @type {DefectListResponseAllOfResult}
     * @memberof DefectListResponseAllOf
     */
    result?: DefectListResponseAllOfResult;
}

export function DefectListResponseAllOfFromJSON(json: any): DefectListResponseAllOf {
    return DefectListResponseAllOfFromJSONTyped(json, false);
}

export function DefectListResponseAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): DefectListResponseAllOf {
...
export function DefectListResponseAllOfToJSON(value?: DefectListResponseAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
