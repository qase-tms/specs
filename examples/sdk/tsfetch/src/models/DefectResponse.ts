...
import {
    DefectResponseAllOf,
    DefectResponseAllOfFromJSON,
    DefectResponseAllOfFromJSONTyped,
    DefectResponseAllOfToJSON,
} from './DefectResponseAllOf';
import {
    Response,
    ResponseFromJSON,
...
export function DefectResponseFromJSON(json: any): DefectResponse {
    return DefectResponseFromJSONTyped(json, false);
}

export function DefectResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): DefectResponse {
    ...
    return {
        ...
        'result': !exists(json, 'result') ? undefined : DefectFromJSON(json['result']),
    };
}

export function DefectResponseToJSON(value?: DefectResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'status': value.status,
        'result': DefectToJSON(value.result),
    };
}
