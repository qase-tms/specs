...
export function DefectResponseAllOfFromJSON(json: any): DefectResponseAllOf {
    return DefectResponseAllOfFromJSONTyped(json, false);
}

export function DefectResponseAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): DefectResponseAllOf {
...
export function DefectResponseAllOfToJSON(value?: DefectResponseAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
