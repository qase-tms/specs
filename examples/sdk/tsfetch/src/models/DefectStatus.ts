...
export interface DefectStatus {
     ...
     * 
     * @type {string}
     * @memberof DefectStatus
     */
    status: DefectStatusStatusEnum;
}
...
* @enum {string}
*/
export enum DefectStatusStatusEnum {
    IN_PROGRESS = 'in_progress',
    RESOLVED = 'resolved',
    INVALID = 'invalid'
}

export function DefectStatusFromJSON(json: any): DefectStatus {
    return DefectStatusFromJSONTyped(json, false);
}

export function DefectStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): DefectStatus {
...
export function DefectStatusToJSON(value?: DefectStatus | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
