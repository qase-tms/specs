...
export function EnvironmentCreateFromJSON(json: any): EnvironmentCreate {
    return EnvironmentCreateFromJSONTyped(json, false);
}

export function EnvironmentCreateFromJSONTyped(json: any, ignoreDiscriminator: boolean): EnvironmentCreate {
...
export function EnvironmentCreateToJSON(value?: EnvironmentCreate | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
