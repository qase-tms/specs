...
import {
    ...
    EnvironmentListResponseAllOfFromJSON,
    EnvironmentListResponseAllOfFromJSONTyped,
    EnvironmentListResponseAllOfToJSON,
} from './EnvironmentListResponseAllOf';
import {
...
export function EnvironmentListResponseFromJSON(json: any): EnvironmentListResponse {
    return EnvironmentListResponseFromJSONTyped(json, false);
}

export function EnvironmentListResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): EnvironmentListResponse {
...
export function EnvironmentListResponseToJSON(value?: EnvironmentListResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
