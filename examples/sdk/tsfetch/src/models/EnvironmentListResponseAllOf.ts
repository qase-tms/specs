...
import {
    ...
    EnvironmentListResponseAllOfResultFromJSON,
    EnvironmentListResponseAllOfResultFromJSONTyped,
    EnvironmentListResponseAllOfResultToJSON,
} from './EnvironmentListResponseAllOfResult';

/**
 * 
 * @export
 * @interface EnvironmentListResponseAllOf
 */
export interface EnvironmentListResponseAllOf {
    /**
     * 
     * @type {EnvironmentListResponseAllOfResult}
     * @memberof EnvironmentListResponseAllOf
     */
    result?: EnvironmentListResponseAllOfResult;
}

export function EnvironmentListResponseAllOfFromJSON(json: any): EnvironmentListResponseAllOf {
    return EnvironmentListResponseAllOfFromJSONTyped(json, false);
}

export function EnvironmentListResponseAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): EnvironmentListResponseAllOf {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'result': !exists(json, 'result') ? undefined : EnvironmentListResponseAllOfResultFromJSON(json['result']),
    };
}

export function EnvironmentListResponseAllOfToJSON(value?: EnvironmentListResponseAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'result': EnvironmentListResponseAllOfResultToJSON(value.result),
    };
}
