...
export function EnvironmentListResponseAllOfResultFromJSON(json: any): EnvironmentListResponseAllOfResult {
    return EnvironmentListResponseAllOfResultFromJSONTyped(json, false);
}

export function EnvironmentListResponseAllOfResultFromJSONTyped(json: any, ignoreDiscriminator: boolean): EnvironmentListResponseAllOfResult {
    ...
    return {
        ...
        'entities': !exists(json, 'entities') ? undefined : ((json['entities'] as Array<any>).map(EnvironmentFromJSON)),
    };
}

export function EnvironmentListResponseAllOfResultToJSON(value?: EnvironmentListResponseAllOfResult | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'count': value.count,
        'entities': value.entities === undefined ? undefined : ((value.entities as Array<any>).map(EnvironmentToJSON)),
    };
}
