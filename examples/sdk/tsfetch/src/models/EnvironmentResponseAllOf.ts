...
export function EnvironmentResponseAllOfFromJSON(json: any): EnvironmentResponseAllOf {
    return EnvironmentResponseAllOfFromJSONTyped(json, false);
}

export function EnvironmentResponseAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): EnvironmentResponseAllOf {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'result': !exists(json, 'result') ? undefined : EnvironmentFromJSON(json['result']),
    };
}

export function EnvironmentResponseAllOfToJSON(value?: EnvironmentResponseAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'result': EnvironmentToJSON(value.result),
    };
}
