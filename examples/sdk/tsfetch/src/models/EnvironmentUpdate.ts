...
export function EnvironmentUpdateFromJSON(json: any): EnvironmentUpdate {
    return EnvironmentUpdateFromJSONTyped(json, false);
}

export function EnvironmentUpdateFromJSONTyped(json: any, ignoreDiscriminator: boolean): EnvironmentUpdate {
...
export function EnvironmentUpdateToJSON(value?: EnvironmentUpdate | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
