...
export function Filters1FromJSON(json: any): Filters1 {
    return Filters1FromJSONTyped(json, false);
}

export function Filters1FromJSONTyped(json: any, ignoreDiscriminator: boolean): Filters1 {
...
export function Filters1ToJSON(value?: Filters1 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
