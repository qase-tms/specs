...
export function Filters2FromJSON(json: any): Filters2 {
    return Filters2FromJSONTyped(json, false);
}

export function Filters2FromJSONTyped(json: any, ignoreDiscriminator: boolean): Filters2 {
...
export function Filters2ToJSON(value?: Filters2 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
