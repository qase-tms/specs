...
export function Filters3FromJSON(json: any): Filters3 {
    return Filters3FromJSONTyped(json, false);
}

export function Filters3FromJSONTyped(json: any, ignoreDiscriminator: boolean): Filters3 {
...
export function Filters3ToJSON(value?: Filters3 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
