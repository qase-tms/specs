...
export function Filters4FromJSON(json: any): Filters4 {
    return Filters4FromJSONTyped(json, false);
}

export function Filters4FromJSONTyped(json: any, ignoreDiscriminator: boolean): Filters4 {
    ...
    return {
        ...
        'fromEndTime': !exists(json, 'from_end_time') ? undefined : json['from_end_time'],
        'toEndTime': !exists(json, 'to_end_time') ? undefined : json['to_end_time'],
    };
}

export function Filters4ToJSON(value?: Filters4 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'member': value.member,
        'api': value.api,
        'from_end_time': value.fromEndTime,
        'to_end_time': value.toEndTime,
    };
}
