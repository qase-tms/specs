...
export function Filters5FromJSON(json: any): Filters5 {
    return Filters5FromJSONTyped(json, false);
}

export function Filters5FromJSONTyped(json: any, ignoreDiscriminator: boolean): Filters5 {
    ...
    return {
        ...
        'fromStartTime': !exists(json, 'from_start_time') ? undefined : json['from_start_time'],
        'toStartTime': !exists(json, 'to_start_time') ? undefined : json['to_start_time'],
    };
}

export function Filters5ToJSON(value?: Filters5 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'from_start_time': value.fromStartTime,
        'to_start_time': value.toStartTime,
    };
}
