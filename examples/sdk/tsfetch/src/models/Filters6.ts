...
export function Filters6FromJSON(json: any): Filters6 {
    return Filters6FromJSONTyped(json, false);
}

export function Filters6FromJSONTyped(json: any, ignoreDiscriminator: boolean): Filters6 {
...
export function Filters6ToJSON(value?: Filters6 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
