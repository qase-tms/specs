...
export function Filters7FromJSON(json: any): Filters7 {
    return Filters7FromJSONTyped(json, false);
}

export function Filters7FromJSONTyped(json: any, ignoreDiscriminator: boolean): Filters7 {
...
export function Filters7ToJSON(value?: Filters7 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
