...
import {
    HashResponseAllOf,
    HashResponseAllOfFromJSON,
    HashResponseAllOfFromJSONTyped,
    HashResponseAllOfToJSON,
} from './HashResponseAllOf';
import {
...
export function HashResponseToJSON(value?: HashResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
