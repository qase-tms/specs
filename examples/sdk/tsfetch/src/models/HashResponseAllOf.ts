...
import {
    ...
    HashResponseAllOfResultFromJSON,
    HashResponseAllOfResultFromJSONTyped,
    HashResponseAllOfResultToJSON,
} from './HashResponseAllOfResult';

/**
 * 
 * @export
 * @interface HashResponseAllOf
 */
export interface HashResponseAllOf {
    /**
     * 
     * @type {HashResponseAllOfResult}
     * @memberof HashResponseAllOf
     */
    result?: HashResponseAllOfResult;
}

export function HashResponseAllOfFromJSON(json: any): HashResponseAllOf {
    return HashResponseAllOfFromJSONTyped(json, false);
}

export function HashResponseAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): HashResponseAllOf {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'result': !exists(json, 'result') ? undefined : HashResponseAllOfResultFromJSON(json['result']),
    };
}

export function HashResponseAllOfToJSON(value?: HashResponseAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'result': HashResponseAllOfResultToJSON(value.result),
    };
}
