 ...
 * 
 * @export
 * @interface HashResponseAllOfResult
 */
export interface HashResponseAllOfResult {
    /**
     * 
     * @type {string}
     * @memberof HashResponseAllOfResult
     */
    hash?: string;
}

export function HashResponseAllOfResultFromJSON(json: any): HashResponseAllOfResult {
    return HashResponseAllOfResultFromJSONTyped(json, false);
}

export function HashResponseAllOfResultFromJSONTyped(json: any, ignoreDiscriminator: boolean): HashResponseAllOfResult {
...
export function HashResponseAllOfResultToJSON(value?: HashResponseAllOfResult | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
