...
import {
    ...
    IdResponseAllOfResultFromJSON,
    IdResponseAllOfResultFromJSONTyped,
    IdResponseAllOfResultToJSON,
} from './IdResponseAllOfResult';

/**
 * 
 * @export
 * @interface IdResponseAllOf
 */
export interface IdResponseAllOf {
    /**
     * 
     * @type {IdResponseAllOfResult}
     * @memberof IdResponseAllOf
     */
    result?: IdResponseAllOfResult;
}

export function IdResponseAllOfFromJSON(json: any): IdResponseAllOf {
    return IdResponseAllOfFromJSONTyped(json, false);
}

export function IdResponseAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): IdResponseAllOf {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'result': !exists(json, 'result') ? undefined : IdResponseAllOfResultFromJSON(json['result']),
    };
}

export function IdResponseAllOfToJSON(value?: IdResponseAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'result': IdResponseAllOfResultToJSON(value.result),
    };
}
