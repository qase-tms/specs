 ...
 * 
 * @export
 * @interface IdResponseAllOfResult
 */
export interface IdResponseAllOfResult {
    /**
     * 
     * @type {number}
     * @memberof IdResponseAllOfResult
     */
    id?: number;
}

export function IdResponseAllOfResultFromJSON(json: any): IdResponseAllOfResult {
    return IdResponseAllOfResultFromJSONTyped(json, false);
}

export function IdResponseAllOfResultFromJSONTyped(json: any, ignoreDiscriminator: boolean): IdResponseAllOfResult {
...
export function IdResponseAllOfResultToJSON(value?: IdResponseAllOfResult | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
