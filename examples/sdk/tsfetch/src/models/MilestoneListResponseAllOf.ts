...
import {
    ...
    MilestoneListResponseAllOfResultFromJSON,
    MilestoneListResponseAllOfResultFromJSONTyped,
    MilestoneListResponseAllOfResultToJSON,
} from './MilestoneListResponseAllOfResult';
...
export function MilestoneListResponseAllOfFromJSON(json: any): MilestoneListResponseAllOf {
    return MilestoneListResponseAllOfFromJSONTyped(json, false);
}

export function MilestoneListResponseAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): MilestoneListResponseAllOf {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'result': !exists(json, 'result') ? undefined : MilestoneListResponseAllOfResultFromJSON(json['result']),
    };
}

export function MilestoneListResponseAllOfToJSON(value?: MilestoneListResponseAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'result': MilestoneListResponseAllOfResultToJSON(value.result),
    };
}
