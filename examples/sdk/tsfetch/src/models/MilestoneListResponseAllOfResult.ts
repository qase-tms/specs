...
export function MilestoneListResponseAllOfResultFromJSON(json: any): MilestoneListResponseAllOfResult {
    return MilestoneListResponseAllOfResultFromJSONTyped(json, false);
}

export function MilestoneListResponseAllOfResultFromJSONTyped(json: any, ignoreDiscriminator: boolean): MilestoneListResponseAllOfResult {
    ...
    return {
        ...
        'entities': !exists(json, 'entities') ? undefined : ((json['entities'] as Array<any>).map(MilestoneFromJSON)),
    };
}

export function MilestoneListResponseAllOfResultToJSON(value?: MilestoneListResponseAllOfResult | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'count': value.count,
        'entities': value.entities === undefined ? undefined : ((value.entities as Array<any>).map(MilestoneToJSON)),
    };
}
