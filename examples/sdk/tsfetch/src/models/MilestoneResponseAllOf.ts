 ...
 * 
 * @export
 * @interface MilestoneResponseAllOf
 */
export interface MilestoneResponseAllOf {
    /**
     * 
     * @type {Milestone}
     * @memberof MilestoneResponseAllOf
     */
    result?: Milestone;
}

export function MilestoneResponseAllOfFromJSON(json: any): MilestoneResponseAllOf {
    return MilestoneResponseAllOfFromJSONTyped(json, false);
}

export function MilestoneResponseAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): MilestoneResponseAllOf {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'result': !exists(json, 'result') ? undefined : MilestoneFromJSON(json['result']),
    };
}

export function MilestoneResponseAllOfToJSON(value?: MilestoneResponseAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'result': MilestoneToJSON(value.result),
    };
}
