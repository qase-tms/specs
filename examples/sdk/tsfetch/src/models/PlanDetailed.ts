...
import {
    PlanDetailedAllOf,
    PlanDetailedAllOfFromJSON,
    PlanDetailedAllOfFromJSONTyped,
    PlanDetailedAllOfToJSON,
} from './PlanDetailedAllOf';
import {
    PlanDetailedAllOfCases,
    PlanDetailedAllOfCasesFromJSON,
    PlanDetailedAllOfCasesFromJSONTyped,
    PlanDetailedAllOfCasesToJSON,
} from './PlanDetailedAllOfCases';

/**
 * 
 * @export
 * @interface PlanDetailed
 */
export interface PlanDetailed {
    /**
     * 
     * @type {number}
     * @memberof PlanDetailed
     */
    id?: number;
    /**
     * 
...
export function PlanDetailedFromJSON(json: any): PlanDetailed {
    return PlanDetailedFromJSONTyped(json, false);
}

export function PlanDetailedFromJSONTyped(json: any, ignoreDiscriminator: boolean): PlanDetailed {
    ...
    return {
        ...
        'casesCount': !exists(json, 'cases_count') ? undefined : json['cases_count'],
        'created': !exists(json, 'created') ? undefined : (new Date(json['created'])),
        'updated': !exists(json, 'updated') ? undefined : (json['updated'] === null ? null : new Date(json['updated'])),
        'averageTime': !exists(json, 'average_time') ? undefined : json['average_time'],
        'cases': !exists(json, 'cases') ? undefined : ((json['cases'] as Array<any>).map(PlanDetailedAllOfCasesFromJSON)),
    };
}

export function PlanDetailedToJSON(value?: PlanDetailed | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'cases_count': value.casesCount,
        'created': value.created === undefined ? undefined : (value.created.toISOString()),
        'updated': value.updated === undefined ? undefined : (value.updated === null ? null : value.updated.toISOString()),
        'average_time': value.averageTime,
        'cases': value.cases === undefined ? undefined : ((value.cases as Array<any>).map(PlanDetailedAllOfCasesToJSON)),
    };
}
