...
export function PlanDetailedAllOfFromJSON(json: any): PlanDetailedAllOf {
    return PlanDetailedAllOfFromJSONTyped(json, false);
}

export function PlanDetailedAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): PlanDetailedAllOf {
...
export function PlanDetailedAllOfToJSON(value?: PlanDetailedAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
