...
export function PlanDetailedAllOfCasesFromJSON(json: any): PlanDetailedAllOfCases {
    return PlanDetailedAllOfCasesFromJSONTyped(json, false);
}

export function PlanDetailedAllOfCasesFromJSONTyped(json: any, ignoreDiscriminator: boolean): PlanDetailedAllOfCases {
...
export function PlanDetailedAllOfCasesToJSON(value?: PlanDetailedAllOfCases | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
