...
import {
    ...
    PlanListResponseAllOfFromJSON,
    PlanListResponseAllOfFromJSONTyped,
    PlanListResponseAllOfToJSON,
} from './PlanListResponseAllOf';
import {
...
export function PlanListResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): PlanListResponse {
...
export function PlanListResponseToJSON(value?: PlanListResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
