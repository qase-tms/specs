...
import {
    ...
    PlanListResponseAllOfResultFromJSON,
    PlanListResponseAllOfResultFromJSONTyped,
    PlanListResponseAllOfResultToJSON,
} from './PlanListResponseAllOfResult';

/**
 * 
 * @export
 * @interface PlanListResponseAllOf
 */
export interface PlanListResponseAllOf {
    /**
     * 
     * @type {PlanListResponseAllOfResult}
     * @memberof PlanListResponseAllOf
     */
    result?: PlanListResponseAllOfResult;
}

export function PlanListResponseAllOfFromJSON(json: any): PlanListResponseAllOf {
    return PlanListResponseAllOfFromJSONTyped(json, false);
}

export function PlanListResponseAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): PlanListResponseAllOf {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'result': !exists(json, 'result') ? undefined : PlanListResponseAllOfResultFromJSON(json['result']),
    };
}

export function PlanListResponseAllOfToJSON(value?: PlanListResponseAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'result': PlanListResponseAllOfResultToJSON(value.result),
    };
}
