 ...
 * 
 * @export
 * @interface PlanListResponseAllOfResult
 */
export interface PlanListResponseAllOfResult {
    /**
     * 
     * @type {number}
     * @memberof PlanListResponseAllOfResult
     */
    total?: number;
    /**
     * 
...
export function PlanListResponseAllOfResultFromJSON(json: any): PlanListResponseAllOfResult {
    return PlanListResponseAllOfResultFromJSONTyped(json, false);
}

export function PlanListResponseAllOfResultFromJSONTyped(json: any, ignoreDiscriminator: boolean): PlanListResponseAllOfResult {
    ...
    return {
        ...
        'entities': !exists(json, 'entities') ? undefined : ((json['entities'] as Array<any>).map(PlanFromJSON)),
    };
}

export function PlanListResponseAllOfResultToJSON(value?: PlanListResponseAllOfResult | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'count': value.count,
        'entities': value.entities === undefined ? undefined : ((value.entities as Array<any>).map(PlanToJSON)),
    };
}
