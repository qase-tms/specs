...
import {
    PlanDetailed,
    PlanDetailedFromJSON,
    PlanDetailedFromJSONTyped,
    PlanDetailedToJSON,
} from './PlanDetailed';
 ...
 * 
 * @export
 * @interface PlanResponseAllOf
 */
export interface PlanResponseAllOf {
    /**
     * 
     * @type {PlanDetailed}
     * @memberof PlanResponseAllOf
     */
    result?: PlanDetailed;
}

export function PlanResponseAllOfFromJSON(json: any): PlanResponseAllOf {
    return PlanResponseAllOfFromJSONTyped(json, false);
}

export function PlanResponseAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): PlanResponseAllOf {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'result': !exists(json, 'result') ? undefined : PlanDetailedFromJSON(json['result']),
    };
}

export function PlanResponseAllOfToJSON(value?: PlanResponseAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'result': PlanDetailedToJSON(value.result),
    };
}
