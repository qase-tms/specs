...
import {
    ProjectCounts,
    ProjectCountsFromJSON,
    ProjectCountsFromJSONTyped,
    ProjectCountsToJSON,
} from './ProjectCounts';
...
export function ProjectFromJSONTyped(json: any, ignoreDiscriminator: boolean): Project {
    ...
    return {
        ...
        'counts': !exists(json, 'counts') ? undefined : ProjectCountsFromJSON(json['counts']),
    };
}
...
export function ProjectToJSON(value?: Project | null): any {
    ...
    return {
        ...
        'title': value.title,
        'code': value.code,
        'counts': ProjectCountsToJSON(value.counts),
    };
}
