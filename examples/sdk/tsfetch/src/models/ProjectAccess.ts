...
export function ProjectAccessFromJSON(json: any): ProjectAccess {
    return ProjectAccessFromJSONTyped(json, false);
}

export function ProjectAccessFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProjectAccess {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'memeberId': !exists(json, 'memeber_id') ? undefined : json['memeber_id'],
    };
}

export function ProjectAccessToJSON(value?: ProjectAccess | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
