...
import {
    ...
    ProjectCodeResponseAllOfFromJSON,
    ProjectCodeResponseAllOfFromJSONTyped,
    ProjectCodeResponseAllOfToJSON,
} from './ProjectCodeResponseAllOf';
import {
    ProjectCodeResponseAllOfResult,
    ProjectCodeResponseAllOfResultFromJSON,
    ProjectCodeResponseAllOfResultFromJSONTyped,
    ProjectCodeResponseAllOfResultToJSON,
} from './ProjectCodeResponseAllOfResult';
import {
    Response,
    ResponseFromJSON,
...
export interface ProjectCodeResponse {
     ...
     * 
     * @type {boolean}
     * @memberof ProjectCodeResponse
     */
    status?: boolean;
    /**
     * 
     * @type {ProjectCodeResponseAllOfResult}
     * @memberof ProjectCodeResponse
     */
    result?: ProjectCodeResponseAllOfResult;
}

export function ProjectCodeResponseFromJSON(json: any): ProjectCodeResponse {
    return ProjectCodeResponseFromJSONTyped(json, false);
}

export function ProjectCodeResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProjectCodeResponse {
    ...
    return {
        ...
        'result': !exists(json, 'result') ? undefined : ProjectCodeResponseAllOfResultFromJSON(json['result']),
    };
}

export function ProjectCodeResponseToJSON(value?: ProjectCodeResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'status': value.status,
        'result': ProjectCodeResponseAllOfResultToJSON(value.result),
    };
}
