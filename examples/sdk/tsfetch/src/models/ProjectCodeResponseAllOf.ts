 ...
 * 
 * @export
 * @interface ProjectCodeResponseAllOf
 */
export interface ProjectCodeResponseAllOf {
    /**
     * 
     * @type {ProjectCodeResponseAllOfResult}
     * @memberof ProjectCodeResponseAllOf
     */
    result?: ProjectCodeResponseAllOfResult;
}

export function ProjectCodeResponseAllOfFromJSON(json: any): ProjectCodeResponseAllOf {
    return ProjectCodeResponseAllOfFromJSONTyped(json, false);
}

export function ProjectCodeResponseAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProjectCodeResponseAllOf {
...
export function ProjectCodeResponseAllOfToJSON(value?: ProjectCodeResponseAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
