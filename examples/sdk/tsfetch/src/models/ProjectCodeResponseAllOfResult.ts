 ...
 * 
 * @export
 * @interface ProjectCodeResponseAllOfResult
 */
export interface ProjectCodeResponseAllOfResult {
    /**
     * 
     * @type {string}
     * @memberof ProjectCodeResponseAllOfResult
     */
    code?: string;
}

export function ProjectCodeResponseAllOfResultFromJSON(json: any): ProjectCodeResponseAllOfResult {
    return ProjectCodeResponseAllOfResultFromJSONTyped(json, false);
}

export function ProjectCodeResponseAllOfResultFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProjectCodeResponseAllOfResult {
...
export function ProjectCodeResponseAllOfResultToJSON(value?: ProjectCodeResponseAllOfResult | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
