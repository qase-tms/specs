...
import {
    ...
    ProjectCountsDefectsFromJSON,
    ProjectCountsDefectsFromJSONTyped,
    ProjectCountsDefectsToJSON,
} from './ProjectCountsDefects';
import {
    ProjectCountsRuns,
    ProjectCountsRunsFromJSON,
    ProjectCountsRunsFromJSONTyped,
    ProjectCountsRunsToJSON,
} from './ProjectCountsRuns';
...
export function ProjectCountsFromJSON(json: any): ProjectCounts {
    return ProjectCountsFromJSONTyped(json, false);
}

export function ProjectCountsFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProjectCounts {
    ...
    return {
        ...
        'milestones': !exists(json, 'milestones') ? undefined : json['milestones'],
        'runs': !exists(json, 'runs') ? undefined : ProjectCountsRunsFromJSON(json['runs']),
        'defects': !exists(json, 'defects') ? undefined : ProjectCountsDefectsFromJSON(json['defects']),
    };
}

export function ProjectCountsToJSON(value?: ProjectCounts | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'runs': ProjectCountsRunsToJSON(value.runs),
        'defects': ProjectCountsDefectsToJSON(value.defects),
    };
}
