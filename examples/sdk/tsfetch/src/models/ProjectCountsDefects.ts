...
export function ProjectCountsDefectsFromJSON(json: any): ProjectCountsDefects {
    return ProjectCountsDefectsFromJSONTyped(json, false);
}

export function ProjectCountsDefectsFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProjectCountsDefects {
...
export function ProjectCountsDefectsToJSON(value?: ProjectCountsDefects | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
