...
export function ProjectCountsRunsFromJSON(json: any): ProjectCountsRuns {
    return ProjectCountsRunsFromJSONTyped(json, false);
}

export function ProjectCountsRunsFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProjectCountsRuns {
...
export function ProjectCountsRunsToJSON(value?: ProjectCountsRuns | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
