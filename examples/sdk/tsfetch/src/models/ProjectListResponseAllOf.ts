...
import {
    ...
    ProjectListResponseAllOfResultFromJSON,
    ProjectListResponseAllOfResultFromJSONTyped,
    ProjectListResponseAllOfResultToJSON,
} from './ProjectListResponseAllOfResult';
...
export function ProjectListResponseAllOfFromJSON(json: any): ProjectListResponseAllOf {
    return ProjectListResponseAllOfFromJSONTyped(json, false);
}

export function ProjectListResponseAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProjectListResponseAllOf {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'result': !exists(json, 'result') ? undefined : ProjectListResponseAllOfResultFromJSON(json['result']),
    };
}

export function ProjectListResponseAllOfToJSON(value?: ProjectListResponseAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'result': ProjectListResponseAllOfResultToJSON(value.result),
    };
}
