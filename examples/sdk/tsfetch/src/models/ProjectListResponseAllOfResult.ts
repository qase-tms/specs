...
export function ProjectListResponseAllOfResultFromJSON(json: any): ProjectListResponseAllOfResult {
    return ProjectListResponseAllOfResultFromJSONTyped(json, false);
}

export function ProjectListResponseAllOfResultFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProjectListResponseAllOfResult {
    ...
    return {
        ...
        'entities': !exists(json, 'entities') ? undefined : ((json['entities'] as Array<any>).map(ProjectFromJSON)),
    };
}

export function ProjectListResponseAllOfResultToJSON(value?: ProjectListResponseAllOfResult | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'count': value.count,
        'entities': value.entities === undefined ? undefined : ((value.entities as Array<any>).map(ProjectToJSON)),
    };
}
