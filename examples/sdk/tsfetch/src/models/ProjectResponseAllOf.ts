...
export function ProjectResponseAllOfFromJSON(json: any): ProjectResponseAllOf {
    return ProjectResponseAllOfFromJSONTyped(json, false);
}

export function ProjectResponseAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProjectResponseAllOf {
...
export function ProjectResponseAllOfToJSON(value?: ProjectResponseAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
