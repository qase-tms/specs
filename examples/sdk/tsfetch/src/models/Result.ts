...
export function ResultFromJSONTyped(json: any, ignoreDiscriminator: boolean): Result {
    ...
    return {
        ...
        'steps': !exists(json, 'steps') ? undefined : ((json['steps'] as Array<any>).map(ResultStepsFromJSON)),
        'status': !exists(json, 'status') ? undefined : json['status'],
        'isApiResult': !exists(json, 'is_api_result') ? undefined : json['is_api_result'],
        'timeSpentMs': !exists(json, 'time_spent_ms') ? undefined : json['time_spent_ms'],
...
export function ResultToJSON(value?: Result | null): any {
    ...
    return {
        ...
        'steps': value.steps === undefined ? undefined : ((value.steps as Array<any>).map(ResultStepsToJSON)),
        'status': value.status,
        'is_api_result': value.isApiResult,
        'time_spent_ms': value.timeSpentMs,
