...
import {
    ResultCreateCase,
    ResultCreateCaseFromJSON,
    ResultCreateCaseFromJSONTyped,
    ResultCreateCaseToJSON,
} from './ResultCreateCase';
import {
    ResultCreateSteps,
    ResultCreateStepsFromJSON,
    ResultCreateStepsFromJSONTyped,
    ResultCreateStepsToJSON,
} from './ResultCreateSteps';
...
export function ResultCreateFromJSON(json: any): ResultCreate {
    return ResultCreateFromJSONTyped(json, false);
}

export function ResultCreateFromJSONTyped(json: any, ignoreDiscriminator: boolean): ResultCreate {
    ...
    return {
        ...
        '_case': !exists(json, 'case') ? undefined : ResultCreateCaseFromJSON(json['case']),
        'status': !exists(json, 'status') ? undefined : json['status'],
        'time': !exists(json, 'time') ? undefined : json['time'],
        'timeMs': !exists(json, 'time_ms') ? undefined : json['time_ms'],
        'defect': !exists(json, 'defect') ? undefined : json['defect'],
        ...
        'steps': !exists(json, 'steps') ? undefined : (json['steps'] === null ? null : (json['steps'] as Array<any>).map(ResultCreateStepsFromJSON)),
    };
}

export function ResultCreateToJSON(value?: ResultCreate | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'case': ResultCreateCaseToJSON(value._case),
        'status': value.status,
        'time': value.time,
        ...
        'param': value.param,
        'steps': value.steps === undefined ? undefined : (value.steps === null ? null : (value.steps as Array<any>).map(ResultCreateStepsToJSON)),
    };
}
