...
import {
    ResultCreate,
    ResultCreateFromJSON,
    ResultCreateFromJSONTyped,
    ResultCreateToJSON,
} from './ResultCreate';
...
export function ResultCreateBulkFromJSON(json: any): ResultCreateBulk {
    return ResultCreateBulkFromJSONTyped(json, false);
}

export function ResultCreateBulkFromJSONTyped(json: any, ignoreDiscriminator: boolean): ResultCreateBulk {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'results': ((json['results'] as Array<any>).map(ResultCreateFromJSON)),
    };
}

export function ResultCreateBulkToJSON(value?: ResultCreateBulk | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'results': ((value.results as Array<any>).map(ResultCreateToJSON)),
    };
}
