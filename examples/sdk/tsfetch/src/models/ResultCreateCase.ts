...
export function ResultCreateCaseFromJSON(json: any): ResultCreateCase {
    return ResultCreateCaseFromJSONTyped(json, false);
}

export function ResultCreateCaseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ResultCreateCase {
    ...
    return {
        ...
        'suiteTitle': !exists(json, 'suite_title') ? undefined : json['suite_title'],
...
export function ResultCreateCaseToJSON(value?: ResultCreateCase | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
