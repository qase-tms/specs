...
export function ResultCreateStepsFromJSON(json: any): ResultCreateSteps {
    return ResultCreateStepsFromJSONTyped(json, false);
}

export function ResultCreateStepsFromJSONTyped(json: any, ignoreDiscriminator: boolean): ResultCreateSteps {
...
export function ResultCreateStepsToJSON(value?: ResultCreateSteps | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
