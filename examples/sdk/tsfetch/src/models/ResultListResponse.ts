...
import {
    ...
    ResultListResponseAllOfFromJSON,
    ResultListResponseAllOfFromJSONTyped,
    ResultListResponseAllOfToJSON,
} from './ResultListResponseAllOf';
import {
...
export function ResultListResponseToJSON(value?: ResultListResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
