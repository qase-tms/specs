...
import {
    ...
    ResultListResponseAllOfResultFromJSON,
    ResultListResponseAllOfResultFromJSONTyped,
    ResultListResponseAllOfResultToJSON,
} from './ResultListResponseAllOfResult';
...
export function ResultListResponseAllOfFromJSON(json: any): ResultListResponseAllOf {
    return ResultListResponseAllOfFromJSONTyped(json, false);
}

export function ResultListResponseAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): ResultListResponseAllOf {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'result': !exists(json, 'result') ? undefined : ResultListResponseAllOfResultFromJSON(json['result']),
    };
}

export function ResultListResponseAllOfToJSON(value?: ResultListResponseAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'result': ResultListResponseAllOfResultToJSON(value.result),
    };
}
