 ...
 * 
 * @export
 * @interface ResultListResponseAllOfResult
 */
...
export function ResultListResponseAllOfResultFromJSON(json: any): ResultListResponseAllOfResult {
    return ResultListResponseAllOfResultFromJSONTyped(json, false);
}

export function ResultListResponseAllOfResultFromJSONTyped(json: any, ignoreDiscriminator: boolean): ResultListResponseAllOfResult {
    ...
    return {
        ...
        'entities': !exists(json, 'entities') ? undefined : ((json['entities'] as Array<any>).map(ResultFromJSON)),
    };
}

export function ResultListResponseAllOfResultToJSON(value?: ResultListResponseAllOfResult | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'count': value.count,
        'entities': value.entities === undefined ? undefined : ((value.entities as Array<any>).map(ResultToJSON)),
    };
}
