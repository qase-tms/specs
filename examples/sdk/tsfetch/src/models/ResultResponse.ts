...
import {
    ResultResponseAllOf,
    ResultResponseAllOfFromJSON,
    ResultResponseAllOfFromJSONTyped,
    ResultResponseAllOfToJSON,
} from './ResultResponseAllOf';
...
export function ResultResponseToJSON(value?: ResultResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
