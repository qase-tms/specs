 ...
 * 
 * @export
 * @interface ResultResponseAllOf
 */
export interface ResultResponseAllOf {
    /**
     * 
     * @type {Result}
     * @memberof ResultResponseAllOf
     */
    result?: Result;
}

export function ResultResponseAllOfFromJSON(json: any): ResultResponseAllOf {
    return ResultResponseAllOfFromJSONTyped(json, false);
}

export function ResultResponseAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): ResultResponseAllOf {
...
export function ResultResponseAllOfToJSON(value?: ResultResponseAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
