...
export function ResultStepsFromJSON(json: any): ResultSteps {
    return ResultStepsFromJSONTyped(json, false);
}

export function ResultStepsFromJSONTyped(json: any, ignoreDiscriminator: boolean): ResultSteps {
...
export function ResultStepsToJSON(value?: ResultSteps | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
