...
import {
    ResultUpdateSteps,
    ResultUpdateStepsFromJSON,
    ResultUpdateStepsFromJSONTyped,
    ResultUpdateStepsToJSON,
} from './ResultUpdateSteps';
...
export function ResultUpdateFromJSON(json: any): ResultUpdate {
    return ResultUpdateFromJSONTyped(json, false);
}

export function ResultUpdateFromJSONTyped(json: any, ignoreDiscriminator: boolean): ResultUpdate {
    ...
    return {
        ...
        'steps': !exists(json, 'steps') ? undefined : (json['steps'] === null ? null : (json['steps'] as Array<any>).map(ResultUpdateStepsFromJSON)),
    };
}

export function ResultUpdateToJSON(value?: ResultUpdate | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'steps': value.steps === undefined ? undefined : (value.steps === null ? null : (value.steps as Array<any>).map(ResultUpdateStepsToJSON)),
    };
}
