...
export function ResultUpdateStepsFromJSON(json: any): ResultUpdateSteps {
    return ResultUpdateStepsFromJSONTyped(json, false);
}

export function ResultUpdateStepsFromJSONTyped(json: any, ignoreDiscriminator: boolean): ResultUpdateSteps {
...
export function ResultUpdateStepsToJSON(value?: ResultUpdateSteps | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
