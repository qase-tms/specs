...
export function RunCreateFromJSON(json: any): RunCreate {
    return RunCreateFromJSONTyped(json, false);
}

export function RunCreateFromJSONTyped(json: any, ignoreDiscriminator: boolean): RunCreate {
    ...
    return {
        ...
        'includeAllCases': !exists(json, 'include_all_cases') ? undefined : json['include_all_cases'],
        'cases': !exists(json, 'cases') ? undefined : json['cases'],
        'isAutotest': !exists(json, 'is_autotest') ? undefined : json['is_autotest'],
...
export function RunCreateToJSON(value?: RunCreate | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'include_all_cases': value.includeAllCases,
        'cases': value.cases,
        'is_autotest': value.isAutotest,
