...
export function RunEnvironmentFromJSON(json: any): RunEnvironment {
    return RunEnvironmentFromJSONTyped(json, false);
}

export function RunEnvironmentFromJSONTyped(json: any, ignoreDiscriminator: boolean): RunEnvironment {
...
export function RunEnvironmentToJSON(value?: RunEnvironment | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
