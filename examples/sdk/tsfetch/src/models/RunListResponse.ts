...
import {
    ...
    RunListResponseAllOfFromJSON,
    RunListResponseAllOfFromJSONTyped,
    RunListResponseAllOfToJSON,
} from './RunListResponseAllOf';
import {
...
export function RunListResponseFromJSON(json: any): RunListResponse {
    return RunListResponseFromJSONTyped(json, false);
}

export function RunListResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): RunListResponse {
...
export function RunListResponseToJSON(value?: RunListResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
