...
import {
    ...
    RunListResponseAllOfResultFromJSON,
    RunListResponseAllOfResultFromJSONTyped,
    RunListResponseAllOfResultToJSON,
} from './RunListResponseAllOfResult';

/**
 * 
 * @export
 * @interface RunListResponseAllOf
 */
export interface RunListResponseAllOf {
    /**
     * 
     * @type {RunListResponseAllOfResult}
     * @memberof RunListResponseAllOf
     */
    result?: RunListResponseAllOfResult;
}

export function RunListResponseAllOfFromJSON(json: any): RunListResponseAllOf {
    return RunListResponseAllOfFromJSONTyped(json, false);
}

export function RunListResponseAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): RunListResponseAllOf {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'result': !exists(json, 'result') ? undefined : RunListResponseAllOfResultFromJSON(json['result']),
    };
}

export function RunListResponseAllOfToJSON(value?: RunListResponseAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'result': RunListResponseAllOfResultToJSON(value.result),
    };
}
