...
export function RunListResponseAllOfResultFromJSON(json: any): RunListResponseAllOfResult {
    return RunListResponseAllOfResultFromJSONTyped(json, false);
}

export function RunListResponseAllOfResultFromJSONTyped(json: any, ignoreDiscriminator: boolean): RunListResponseAllOfResult {
    ...
    return {
        ...
        'entities': !exists(json, 'entities') ? undefined : ((json['entities'] as Array<any>).map(RunFromJSON)),
    };
}

export function RunListResponseAllOfResultToJSON(value?: RunListResponseAllOfResult | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'count': value.count,
        'entities': value.entities === undefined ? undefined : ((value.entities as Array<any>).map(RunToJSON)),
    };
}
