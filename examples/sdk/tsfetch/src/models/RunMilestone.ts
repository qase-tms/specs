...
export function RunMilestoneFromJSON(json: any): RunMilestone {
    return RunMilestoneFromJSONTyped(json, false);
}

export function RunMilestoneFromJSONTyped(json: any, ignoreDiscriminator: boolean): RunMilestone {
...
export function RunMilestoneToJSON(value?: RunMilestone | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
