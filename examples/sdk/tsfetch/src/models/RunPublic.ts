...
export function RunPublicFromJSON(json: any): RunPublic {
    return RunPublicFromJSONTyped(json, false);
}

export function RunPublicFromJSONTyped(json: any, ignoreDiscriminator: boolean): RunPublic {
...
export function RunPublicToJSON(value?: RunPublic | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
