...
import {
    ...
    RunPublicResponseAllOfFromJSON,
    RunPublicResponseAllOfFromJSONTyped,
    RunPublicResponseAllOfToJSON,
} from './RunPublicResponseAllOf';
import {
    RunPublicResponseAllOfResult,
    RunPublicResponseAllOfResultFromJSON,
    RunPublicResponseAllOfResultFromJSONTyped,
    RunPublicResponseAllOfResultToJSON,
} from './RunPublicResponseAllOfResult';

/**
 * 
 * @export
 * @interface RunPublicResponse
 */
export interface RunPublicResponse {
    /**
     * 
     * @type {boolean}
     * @memberof RunPublicResponse
     */
    status?: boolean;
    /**
     * 
     * @type {RunPublicResponseAllOfResult}
     * @memberof RunPublicResponse
     */
    result?: RunPublicResponseAllOfResult;
}

export function RunPublicResponseFromJSON(json: any): RunPublicResponse {
    return RunPublicResponseFromJSONTyped(json, false);
}

export function RunPublicResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): RunPublicResponse {
    ...
    return {
        ...
        'result': !exists(json, 'result') ? undefined : RunPublicResponseAllOfResultFromJSON(json['result']),
    };
}

export function RunPublicResponseToJSON(value?: RunPublicResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'status': value.status,
        'result': RunPublicResponseAllOfResultToJSON(value.result),
    };
}
