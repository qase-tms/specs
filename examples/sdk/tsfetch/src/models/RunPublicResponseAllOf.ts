 ...
 * 
 * @export
 * @interface RunPublicResponseAllOf
 */
export interface RunPublicResponseAllOf {
    /**
     * 
     * @type {RunPublicResponseAllOfResult}
     * @memberof RunPublicResponseAllOf
     */
    result?: RunPublicResponseAllOfResult;
}

export function RunPublicResponseAllOfFromJSON(json: any): RunPublicResponseAllOf {
    return RunPublicResponseAllOfFromJSONTyped(json, false);
}

export function RunPublicResponseAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): RunPublicResponseAllOf {
...
export function RunPublicResponseAllOfToJSON(value?: RunPublicResponseAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
