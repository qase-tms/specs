 ...
 * 
 * @export
 * @interface RunPublicResponseAllOfResult
 */
export interface RunPublicResponseAllOfResult {
    /**
     * 
     * @type {string}
     * @memberof RunPublicResponseAllOfResult
     */
    url?: string;
}

export function RunPublicResponseAllOfResultFromJSON(json: any): RunPublicResponseAllOfResult {
    return RunPublicResponseAllOfResultFromJSONTyped(json, false);
}

export function RunPublicResponseAllOfResultFromJSONTyped(json: any, ignoreDiscriminator: boolean): RunPublicResponseAllOfResult {
...
export function RunPublicResponseAllOfResultToJSON(value?: RunPublicResponseAllOfResult | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
