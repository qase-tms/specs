...
import {
    RunResponseAllOf,
    RunResponseAllOfFromJSON,
    RunResponseAllOfFromJSONTyped,
    RunResponseAllOfToJSON,
} from './RunResponseAllOf';
...
export function RunResponseToJSON(value?: RunResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
