 ...
 * 
 * @export
 * @interface RunResponseAllOf
 */
export interface RunResponseAllOf {
    /**
     * 
     * @type {Run}
     * @memberof RunResponseAllOf
     */
    result?: Run;
}

export function RunResponseAllOfFromJSON(json: any): RunResponseAllOf {
    return RunResponseAllOfFromJSONTyped(json, false);
}

export function RunResponseAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): RunResponseAllOf {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'result': !exists(json, 'result') ? undefined : RunFromJSON(json['result']),
    };
}

export function RunResponseAllOfToJSON(value?: RunResponseAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
