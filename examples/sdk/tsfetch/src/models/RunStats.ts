...
export function RunStatsFromJSON(json: any): RunStats {
    return RunStatsFromJSONTyped(json, false);
}

export function RunStatsFromJSONTyped(json: any, ignoreDiscriminator: boolean): RunStats {
    ...
    return {
        ...
        'untested': !exists(json, 'untested') ? undefined : json['untested'],
