...
import {
    ...
    SearchResponseAllOfResultFromJSON,
    SearchResponseAllOfResultFromJSONTyped,
    SearchResponseAllOfResultToJSON,
} from './SearchResponseAllOfResult';
...
export function SearchResponseAllOfFromJSON(json: any): SearchResponseAllOf {
    return SearchResponseAllOfFromJSONTyped(json, false);
}

export function SearchResponseAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): SearchResponseAllOf {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'result': !exists(json, 'result') ? undefined : SearchResponseAllOfResultFromJSON(json['result']),
    };
}

export function SearchResponseAllOfToJSON(value?: SearchResponseAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'result': SearchResponseAllOfResultToJSON(value.result),
    };
}
