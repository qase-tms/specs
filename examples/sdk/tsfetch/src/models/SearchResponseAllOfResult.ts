...
export function SearchResponseAllOfResultFromJSON(json: any): SearchResponseAllOfResult {
    return SearchResponseAllOfResultFromJSONTyped(json, false);
}

export function SearchResponseAllOfResultFromJSONTyped(json: any, ignoreDiscriminator: boolean): SearchResponseAllOfResult {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'entities': !exists(json, 'entities') ? undefined : ((json['entities'] as Array<any>).map(TestCase | Defect | Run | Result | Plan | RequirementFromJSON)),
    };
}

export function SearchResponseAllOfResultToJSON(value?: SearchResponseAllOfResult | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'entities': value.entities === undefined ? undefined : ((value.entities as Array<any>).map(TestCase | Defect | Run | Result | Plan | RequirementToJSON)),
    };
}
