...
import {
    SharedStepSteps,
    SharedStepStepsFromJSON,
    SharedStepStepsFromJSONTyped,
    SharedStepStepsToJSON,
} from './SharedStepSteps';
...
export function SharedStepFromJSON(json: any): SharedStep {
    return SharedStepFromJSONTyped(json, false);
}

export function SharedStepFromJSONTyped(json: any, ignoreDiscriminator: boolean): SharedStep {
    ...
    return {
        ...
        'steps': !exists(json, 'steps') ? undefined : ((json['steps'] as Array<any>).map(SharedStepStepsFromJSON)),
...
export function SharedStepToJSON(value?: SharedStep | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'steps': value.steps === undefined ? undefined : ((value.steps as Array<any>).map(SharedStepStepsToJSON)),
        'data': value.data,
        'cases': value.cases,
