...
import {
    AttachmentHash,
    AttachmentHashFromJSON,
    AttachmentHashFromJSONTyped,
    AttachmentHashToJSON,
} from './AttachmentHash';
import {
    SharedStepCreateSteps,
    SharedStepCreateStepsFromJSON,
    SharedStepCreateStepsFromJSONTyped,
    SharedStepCreateStepsToJSON,
} from './SharedStepCreateSteps';
...
export function SharedStepCreateFromJSON(json: any): SharedStepCreate {
    return SharedStepCreateFromJSONTyped(json, false);
}

export function SharedStepCreateFromJSONTyped(json: any, ignoreDiscriminator: boolean): SharedStepCreate {
    ...
    return {
        ...
        'expectedResult': !exists(json, 'expected_result') ? undefined : json['expected_result'],
        'data': !exists(json, 'data') ? undefined : json['data'],
        'attachments': !exists(json, 'attachments') ? undefined : ((json['attachments'] as Array<any>).map(AttachmentHashFromJSON)),
        'steps': !exists(json, 'steps') ? undefined : ((json['steps'] as Array<any>).map(SharedStepCreateStepsFromJSON)),
    };
}

export function SharedStepCreateToJSON(value?: SharedStepCreate | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'data': value.data,
        'attachments': value.attachments === undefined ? undefined : ((value.attachments as Array<any>).map(AttachmentHashToJSON)),
        'steps': value.steps === undefined ? undefined : ((value.steps as Array<any>).map(SharedStepCreateStepsToJSON)),
    };
}
