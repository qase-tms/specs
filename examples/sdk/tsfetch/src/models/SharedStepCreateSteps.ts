...
export function SharedStepCreateStepsFromJSON(json: any): SharedStepCreateSteps {
    return SharedStepCreateStepsFromJSONTyped(json, false);
}

export function SharedStepCreateStepsFromJSONTyped(json: any, ignoreDiscriminator: boolean): SharedStepCreateSteps {
...
export function SharedStepCreateStepsToJSON(value?: SharedStepCreateSteps | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
