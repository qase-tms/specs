...
import {
    ...
    SharedStepListResponseAllOfFromJSON,
    SharedStepListResponseAllOfFromJSONTyped,
    SharedStepListResponseAllOfToJSON,
} from './SharedStepListResponseAllOf';
import {
    SharedStepListResponseAllOfResult,
    SharedStepListResponseAllOfResultFromJSON,
    SharedStepListResponseAllOfResultFromJSONTyped,
    SharedStepListResponseAllOfResultToJSON,
} from './SharedStepListResponseAllOfResult';

/**
 * 
 * @export
 * @interface SharedStepListResponse
 */
export interface SharedStepListResponse {
    /**
     * 
     * @type {boolean}
     * @memberof SharedStepListResponse
     */
    status?: boolean;
    /**
     * 
...
export function SharedStepListResponseFromJSON(json: any): SharedStepListResponse {
    return SharedStepListResponseFromJSONTyped(json, false);
}

export function SharedStepListResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): SharedStepListResponse {
    ...
    return {
        ...
        'result': !exists(json, 'result') ? undefined : SharedStepListResponseAllOfResultFromJSON(json['result']),
    };
}

export function SharedStepListResponseToJSON(value?: SharedStepListResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'status': value.status,
        'result': SharedStepListResponseAllOfResultToJSON(value.result),
    };
}
