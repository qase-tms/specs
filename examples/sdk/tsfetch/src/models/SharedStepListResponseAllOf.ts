...
export function SharedStepListResponseAllOfFromJSON(json: any): SharedStepListResponseAllOf {
    return SharedStepListResponseAllOfFromJSONTyped(json, false);
}

export function SharedStepListResponseAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): SharedStepListResponseAllOf {
...
export function SharedStepListResponseAllOfToJSON(value?: SharedStepListResponseAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
