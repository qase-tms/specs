...
export function SharedStepListResponseAllOfResultFromJSON(json: any): SharedStepListResponseAllOfResult {
    return SharedStepListResponseAllOfResultFromJSONTyped(json, false);
}

export function SharedStepListResponseAllOfResultFromJSONTyped(json: any, ignoreDiscriminator: boolean): SharedStepListResponseAllOfResult {
    ...
    return {
        ...
        'entities': !exists(json, 'entities') ? undefined : ((json['entities'] as Array<any>).map(SharedStepFromJSON)),
    };
}

export function SharedStepListResponseAllOfResultToJSON(value?: SharedStepListResponseAllOfResult | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'count': value.count,
        'entities': value.entities === undefined ? undefined : ((value.entities as Array<any>).map(SharedStepToJSON)),
    };
}
