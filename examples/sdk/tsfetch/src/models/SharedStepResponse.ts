...
import {
    ...
    SharedStepResponseAllOfFromJSON,
    SharedStepResponseAllOfFromJSONTyped,
    SharedStepResponseAllOfToJSON,
} from './SharedStepResponseAllOf';
...
export function SharedStepResponseFromJSON(json: any): SharedStepResponse {
    return SharedStepResponseFromJSONTyped(json, false);
}

export function SharedStepResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): SharedStepResponse {
    ...
    return {
        ...
        'result': !exists(json, 'result') ? undefined : SharedStepFromJSON(json['result']),
    };
}

export function SharedStepResponseToJSON(value?: SharedStepResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'status': value.status,
        'result': SharedStepToJSON(value.result),
    };
}
