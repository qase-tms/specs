 ...
 * 
 * @export
 * @interface SharedStepResponseAllOf
 */
export interface SharedStepResponseAllOf {
    /**
     * 
     * @type {SharedStep}
     * @memberof SharedStepResponseAllOf
     */
    result?: SharedStep;
}

export function SharedStepResponseAllOfFromJSON(json: any): SharedStepResponseAllOf {
    return SharedStepResponseAllOfFromJSONTyped(json, false);
}

export function SharedStepResponseAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): SharedStepResponseAllOf {
...
export function SharedStepResponseAllOfToJSON(value?: SharedStepResponseAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
