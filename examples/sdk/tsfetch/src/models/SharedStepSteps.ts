...
export function SharedStepStepsFromJSON(json: any): SharedStepSteps {
    return SharedStepStepsFromJSONTyped(json, false);
}

export function SharedStepStepsFromJSONTyped(json: any, ignoreDiscriminator: boolean): SharedStepSteps {
...
export function SharedStepStepsToJSON(value?: SharedStepSteps | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
