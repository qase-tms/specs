...
export function SharedStepUpdateFromJSON(json: any): SharedStepUpdate {
    return SharedStepUpdateFromJSONTyped(json, false);
}

export function SharedStepUpdateFromJSONTyped(json: any, ignoreDiscriminator: boolean): SharedStepUpdate {
...
export function SharedStepUpdateToJSON(value?: SharedStepUpdate | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
