...
export function SuiteCreateFromJSON(json: any): SuiteCreate {
    return SuiteCreateFromJSONTyped(json, false);
}

export function SuiteCreateFromJSONTyped(json: any, ignoreDiscriminator: boolean): SuiteCreate {
...
export function SuiteCreateToJSON(value?: SuiteCreate | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
