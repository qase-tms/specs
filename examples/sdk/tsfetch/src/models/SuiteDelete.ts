...
export function SuiteDeleteFromJSON(json: any): SuiteDelete {
    return SuiteDeleteFromJSONTyped(json, false);
}

export function SuiteDeleteFromJSONTyped(json: any, ignoreDiscriminator: boolean): SuiteDelete {
...
export function SuiteDeleteToJSON(value?: SuiteDelete | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
