...
import {
    ...
    SuiteListResponseAllOfFromJSON,
    SuiteListResponseAllOfFromJSONTyped,
    SuiteListResponseAllOfToJSON,
} from './SuiteListResponseAllOf';
import {
    SuiteListResponseAllOfResult,
    SuiteListResponseAllOfResultFromJSON,
    SuiteListResponseAllOfResultFromJSONTyped,
    SuiteListResponseAllOfResultToJSON,
} from './SuiteListResponseAllOfResult';
...
export interface SuiteListResponse {
     ...
     * 
     * @type {boolean}
     * @memberof SuiteListResponse
     */
    status?: boolean;
    /**
     * 
     * @type {SuiteListResponseAllOfResult}
     * @memberof SuiteListResponse
     */
    result?: SuiteListResponseAllOfResult;
}

export function SuiteListResponseFromJSON(json: any): SuiteListResponse {
    return SuiteListResponseFromJSONTyped(json, false);
}

export function SuiteListResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): SuiteListResponse {
    ...
    return {
        ...
        'result': !exists(json, 'result') ? undefined : SuiteListResponseAllOfResultFromJSON(json['result']),
    };
}

export function SuiteListResponseToJSON(value?: SuiteListResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'status': value.status,
        'result': SuiteListResponseAllOfResultToJSON(value.result),
    };
}
