 ...
 * 
 * @export
 * @interface SuiteListResponseAllOf
 */
export interface SuiteListResponseAllOf {
    /**
     * 
     * @type {SuiteListResponseAllOfResult}
     * @memberof SuiteListResponseAllOf
     */
    result?: SuiteListResponseAllOfResult;
}

export function SuiteListResponseAllOfFromJSON(json: any): SuiteListResponseAllOf {
    return SuiteListResponseAllOfFromJSONTyped(json, false);
}

export function SuiteListResponseAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): SuiteListResponseAllOf {
...
export function SuiteListResponseAllOfToJSON(value?: SuiteListResponseAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
