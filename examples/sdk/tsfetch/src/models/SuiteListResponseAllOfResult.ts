...
export function SuiteListResponseAllOfResultFromJSON(json: any): SuiteListResponseAllOfResult {
    return SuiteListResponseAllOfResultFromJSONTyped(json, false);
}

export function SuiteListResponseAllOfResultFromJSONTyped(json: any, ignoreDiscriminator: boolean): SuiteListResponseAllOfResult {
    ...
    return {
        ...
        'entities': !exists(json, 'entities') ? undefined : ((json['entities'] as Array<any>).map(SuiteFromJSON)),
    };
}

export function SuiteListResponseAllOfResultToJSON(value?: SuiteListResponseAllOfResult | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'count': value.count,
        'entities': value.entities === undefined ? undefined : ((value.entities as Array<any>).map(SuiteToJSON)),
    };
}
