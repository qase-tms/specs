...
import {
    SuiteResponseAllOf,
    SuiteResponseAllOfFromJSON,
    SuiteResponseAllOfFromJSONTyped,
    SuiteResponseAllOfToJSON,
} from './SuiteResponseAllOf';
...
export function SuiteResponseFromJSON(json: any): SuiteResponse {
    return SuiteResponseFromJSONTyped(json, false);
}

export function SuiteResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): SuiteResponse {
...
export function SuiteResponseToJSON(value?: SuiteResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
