 ...
 * 
 * @export
 * @interface SuiteResponseAllOf
 */
export interface SuiteResponseAllOf {
    /**
     * 
     * @type {Suite}
     * @memberof SuiteResponseAllOf
     */
    result?: Suite;
}

export function SuiteResponseAllOfFromJSON(json: any): SuiteResponseAllOf {
    return SuiteResponseAllOfFromJSONTyped(json, false);
}

export function SuiteResponseAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): SuiteResponseAllOf {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'result': !exists(json, 'result') ? undefined : SuiteFromJSON(json['result']),
    };
}

export function SuiteResponseAllOfToJSON(value?: SuiteResponseAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'result': SuiteToJSON(value.result),
    };
}
