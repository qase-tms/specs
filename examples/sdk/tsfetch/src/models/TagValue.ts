...
export function TagValueFromJSON(json: any): TagValue {
    return TagValueFromJSONTyped(json, false);
}

export function TagValueFromJSONTyped(json: any, ignoreDiscriminator: boolean): TagValue {
...
export function TagValueToJSON(value?: TagValue | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
