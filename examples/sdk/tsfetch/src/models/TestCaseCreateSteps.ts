...
export function TestCaseCreateStepsFromJSON(json: any): TestCaseCreateSteps {
    return TestCaseCreateStepsFromJSONTyped(json, false);
}

export function TestCaseCreateStepsFromJSONTyped(json: any, ignoreDiscriminator: boolean): TestCaseCreateSteps {
...
export function TestCaseCreateStepsToJSON(value?: TestCaseCreateSteps | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
