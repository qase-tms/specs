...
import {
    ...
    TestCaseListResponseAllOfFromJSON,
    TestCaseListResponseAllOfFromJSONTyped,
    TestCaseListResponseAllOfToJSON,
} from './TestCaseListResponseAllOf';
import {
...
export function TestCaseListResponseFromJSON(json: any): TestCaseListResponse {
    return TestCaseListResponseFromJSONTyped(json, false);
}

export function TestCaseListResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): TestCaseListResponse {
...
export function TestCaseListResponseToJSON(value?: TestCaseListResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
