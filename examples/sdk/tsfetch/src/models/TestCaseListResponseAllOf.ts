...
import {
    ...
    TestCaseListResponseAllOfResultFromJSON,
    TestCaseListResponseAllOfResultFromJSONTyped,
    TestCaseListResponseAllOfResultToJSON,
} from './TestCaseListResponseAllOfResult';

/**
 * 
 * @export
 * @interface TestCaseListResponseAllOf
 */
export interface TestCaseListResponseAllOf {
    /**
     * 
     * @type {TestCaseListResponseAllOfResult}
     * @memberof TestCaseListResponseAllOf
     */
    result?: TestCaseListResponseAllOfResult;
}

export function TestCaseListResponseAllOfFromJSON(json: any): TestCaseListResponseAllOf {
    return TestCaseListResponseAllOfFromJSONTyped(json, false);
}

export function TestCaseListResponseAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): TestCaseListResponseAllOf {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'result': !exists(json, 'result') ? undefined : TestCaseListResponseAllOfResultFromJSON(json['result']),
    };
}

export function TestCaseListResponseAllOfToJSON(value?: TestCaseListResponseAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'result': TestCaseListResponseAllOfResultToJSON(value.result),
    };
}
