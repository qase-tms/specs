...
export function TestCaseListResponseAllOfResultFromJSON(json: any): TestCaseListResponseAllOfResult {
    return TestCaseListResponseAllOfResultFromJSONTyped(json, false);
}

export function TestCaseListResponseAllOfResultFromJSONTyped(json: any, ignoreDiscriminator: boolean): TestCaseListResponseAllOfResult {
    ...
    return {
        ...
        'entities': !exists(json, 'entities') ? undefined : ((json['entities'] as Array<any>).map(TestCaseFromJSON)),
    };
}

export function TestCaseListResponseAllOfResultToJSON(value?: TestCaseListResponseAllOfResult | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'count': value.count,
        'entities': value.entities === undefined ? undefined : ((value.entities as Array<any>).map(TestCaseToJSON)),
    };
}
