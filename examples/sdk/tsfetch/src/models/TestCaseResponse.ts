...
import {
    ...
    TestCaseResponseAllOfFromJSON,
    TestCaseResponseAllOfFromJSONTyped,
    TestCaseResponseAllOfToJSON,
} from './TestCaseResponseAllOf';
...
export function TestCaseResponseFromJSON(json: any): TestCaseResponse {
    return TestCaseResponseFromJSONTyped(json, false);
}

export function TestCaseResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): TestCaseResponse {
...
export function TestCaseResponseToJSON(value?: TestCaseResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
