 ...
 * 
 * @export
 * @interface TestCaseResponseAllOf
 */
export interface TestCaseResponseAllOf {
    /**
     * 
     * @type {TestCase}
     * @memberof TestCaseResponseAllOf
     */
    result?: TestCase;
}

export function TestCaseResponseAllOfFromJSON(json: any): TestCaseResponseAllOf {
    return TestCaseResponseAllOfFromJSONTyped(json, false);
}

export function TestCaseResponseAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): TestCaseResponseAllOf {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'result': !exists(json, 'result') ? undefined : TestCaseFromJSON(json['result']),
    };
}

export function TestCaseResponseAllOfToJSON(value?: TestCaseResponseAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'result': TestCaseToJSON(value.result),
    };
}
