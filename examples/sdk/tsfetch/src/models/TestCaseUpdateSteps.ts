...
export function TestCaseUpdateStepsFromJSON(json: any): TestCaseUpdateSteps {
    return TestCaseUpdateStepsFromJSONTyped(json, false);
}

export function TestCaseUpdateStepsFromJSONTyped(json: any, ignoreDiscriminator: boolean): TestCaseUpdateSteps {
...
export function TestCaseUpdateStepsToJSON(value?: TestCaseUpdateSteps | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
