...
export interface TestStep {
     ...
     * @memberof TestStep
     */
    sharedStepHash?: string | null;
    /**
     * 
     * @type {string}
     * @memberof TestStep
     */
    sharedStepNestedHash?: string | null;
    /**
     * 
     * @type {number}
     * @memberof TestStep
...
export function TestStepFromJSONTyped(json: any, ignoreDiscriminator: boolean): TestStep {
    ...
    return {
        ...
        'sharedStepHash': !exists(json, 'shared_step_hash') ? undefined : json['shared_step_hash'],
        'sharedStepNestedHash': !exists(json, 'shared_step_nested_hash') ? undefined : json['shared_step_nested_hash'],
...
export function TestStepToJSON(value?: TestStep | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'hash': value.hash,
        'shared_step_hash': value.sharedStepHash,
        'shared_step_nested_hash': value.sharedStepNestedHash,
