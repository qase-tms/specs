...
import {
    ...
    UserListResponseAllOfResultFromJSON,
    UserListResponseAllOfResultFromJSONTyped,
    UserListResponseAllOfResultToJSON,
} from './UserListResponseAllOfResult';

/**
 * 
 * @export
 * @interface UserListResponseAllOf
 */
export interface UserListResponseAllOf {
    /**
     * 
     * @type {UserListResponseAllOfResult}
     * @memberof UserListResponseAllOf
     */
    result?: UserListResponseAllOfResult;
}

export function UserListResponseAllOfFromJSON(json: any): UserListResponseAllOf {
    return UserListResponseAllOfFromJSONTyped(json, false);
}

export function UserListResponseAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): UserListResponseAllOf {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'result': !exists(json, 'result') ? undefined : UserListResponseAllOfResultFromJSON(json['result']),
    };
}

export function UserListResponseAllOfToJSON(value?: UserListResponseAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'result': UserListResponseAllOfResultToJSON(value.result),
    };
}
