 ...
 * 
 * @export
 * @interface UserListResponseAllOfResult
 */
export interface UserListResponseAllOfResult {
    /**
     * 
     * @type {number}
     * @memberof UserListResponseAllOfResult
     */
    total?: number;
    /**
     * 
...
export function UserListResponseAllOfResultFromJSON(json: any): UserListResponseAllOfResult {
    return UserListResponseAllOfResultFromJSONTyped(json, false);
}

export function UserListResponseAllOfResultFromJSONTyped(json: any, ignoreDiscriminator: boolean): UserListResponseAllOfResult {
    ...
    return {
        ...
        'entities': !exists(json, 'entities') ? undefined : ((json['entities'] as Array<any>).map(UserFromJSON)),
    };
}

export function UserListResponseAllOfResultToJSON(value?: UserListResponseAllOfResult | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'count': value.count,
        'entities': value.entities === undefined ? undefined : ((value.entities as Array<any>).map(UserToJSON)),
    };
}
